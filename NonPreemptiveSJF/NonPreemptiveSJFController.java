...
public class NonPreemptiveSJFController {
    ...
    NonPreemptiveSJFView theView;
    NonPreemptiveSJFModel theModel;

    public NonPreemptiveSJFController(NonPreemptiveSJFView theView, NonPreemptiveSJFModel theModel) {
    ...
    public class ConfirmButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(flag == 0) {
                ...
                // gantt chart making
                GanttChartPanel ganttChartPanel = new GanttChartPanel(theModel.getCompletedQueue());
