...
public class NonPreemptiveSJFView extends JFrame {
    ...
    public NonPreemptiveSJFView() {
        super("Non Preemptive SJF program");
    ...
    public class EnterButton implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            // panel2.add(Box.createVerticalStrut(500));

            // confirmButton.addActionListener(new ConfirmButtonAction());
