...
public class RoundRobinController {
    ...
    RoundRobinView theView;
    RoundRobinModel theModel;

    public RoundRobinController(RoundRobinView theView, RoundRobinModel theModel) {
     ...
     public class ConfirmButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(flag == 0) {
                ...
                theModel.algorithmSchedule();

                // getting all information from each processes
                ...
                // theView.panel3.setLayout(new BoxLayout(theView.panel3, BoxLayout.Y_AXIS));
                theView.remove(theView.panel3);
                theView.add(theView.panel3, BorderLayout.CENTER);
                // theView.panel3.setLayout(new GridLayout(0,1));
                ...
                // gantt chart making
                GanttChartPanel ganttChartPanel = new GanttChartPanel(theModel.getGanttQueue());
                ganttChartPanel.setPreferredSize(new Dimension(775, 100)); // Set your desired size
                JScrollPane scrollPane2 = new JScrollPane(ganttChartPanel);
